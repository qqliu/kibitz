...
kibitz.RecommenderServiceClient.prototype.getPageItems = function(key, page, numPerPage) {
  this.send_getPageItems(key, page, numPerPage);
  return this.recv_getPageItems();
};

kibitz.RecommenderServiceClient.prototype.send_getPageItems = function(key, page, numPerPage) {
...
kibitz.RecommenderServiceClient.prototype.getSearchItems = function(table, query) {
  this.send_getSearchItems(table, query);
  return this.recv_getSearchItems();
};

kibitz.RecommenderServiceClient.prototype.send_getSearchItems = function(table, query) {
