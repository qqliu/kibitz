...
kibitz.RecommenderService_checkUsername_args.prototype.write = function(output) {
  ...
  if (this.iskibitzuser !== null && this.iskibitzuser !== undefined) {
    output.writeFieldBegin('iskibitzuser', Thrift.Type.BOOL, 2);
    output.writeBool(this.iskibitzuser);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
...
kibitz.RecommenderServiceClient.prototype.createNewUser = function(username, email, password, iskibitzuser) {
  this.send_createNewUser(username, email, password, iskibitzuser);
  return this.recv_createNewUser();
};

kibitz.RecommenderServiceClient.prototype.send_createNewUser = function(username, email, password, iskibitzuser) {
...
kibitz.RecommenderServiceClient.prototype.checkUsername = function(username, iskibitzuser) {
  this.send_checkUsername(username, iskibitzuser);
  return this.recv_checkUsername();
};

kibitz.RecommenderServiceClient.prototype.send_checkUsername = function(username, iskibitzuser) {
...
kibitz.RecommenderServiceClient.prototype.checkLogin = function(username, password, iskibitzuser) {
  this.send_checkLogin(username, password, iskibitzuser);
  return this.recv_checkLogin();
};

kibitz.RecommenderServiceClient.prototype.send_checkLogin = function(username, password, iskibitzuser) {
...
kibitz.RecommenderServiceClient.prototype.retrieveUserId = function(username, password) {
  this.send_retrieveUserId(username, password);
  return this.recv_retrieveUserId();
};

kibitz.RecommenderServiceClient.prototype.send_retrieveUserId = function(username, password) {
...
kibitz.RecommenderServiceClient.prototype.initiateModel = function(table, username, password, database) {
  this.send_initiateModel(table, username, password, database);
  this.recv_initiateModel();
};

kibitz.RecommenderServiceClient.prototype.send_initiateModel = function(table, username, password, database) {
