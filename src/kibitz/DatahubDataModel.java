...
public class DatahubDataModel implements DataModel{
	...
	private static final String DEFAULT_DATAHUB_PASSWORD = "uita9924DS#$";

	/** Default Datahub Database */
	private static final String DEFAULT_DATAHUB_DATABASE = "quanquan+plzfeedme";
	
	/** Default Datahub Table Name*/
	private static final String DEFAULT_DATAHUB_TABLENAME = "foods";
