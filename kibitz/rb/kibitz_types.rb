...
class Item
  ...
  FIELDS = {
    ...
    PREDICTEDPREFERENCES => {:type => ::Thrift::Types::DOUBLE, :name => 'predictedPreferences'}
  }
  ...
  def validate
    ...
    raise ::Thrift::ProtocolException.new(::Thrift::ProtocolException::UNKNOWN, 'Required field predictedPreferences is unset!') unless @predictedPreferences
  end
