...
class Item {
   ...
   * @var double
   */
  public $predictedPreferences = null;
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['predictedPreferences'])) {
        $this->predictedPreferences = $vals['predictedPreferences'];
      }
    }
  }
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::DOUBLE) {
            $xfer += $input->readDouble($this->predictedPreferences);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->predictedPreferences !== null) {
      $xfer += $output->writeFieldBegin('predictedPreferences', TType::DOUBLE, 4);
      $xfer += $output->writeDouble($this->predictedPreferences);
      $xfer += $output->writeFieldEnd();
    }
