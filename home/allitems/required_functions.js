...
var process_login = function() {
    ...
    var correct_login = client.checkLogin(username, password, false);
    swap("login_message", "login_panel");
    if (correct_login) {
       setCookie("username", username);
       userId = client.retrieveUserId(username, password);
...
var title = 'allitems' ; $(document).ready(function() { transport.open(); client.initiateModel('allitems', 'quanquan', 'hof9924ne@!', 'demo'); document.getElementById('title').innerHTML = title + ' Recommender'; });