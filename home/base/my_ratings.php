    ...
    <section class="bootshape">
      <div class="center-block main">
        ...
        <div class="navigation text-center">
          <table class="table">
            <tr>
              <td><a href="index.php">All Items</a></td>
              <td><a href="my_recommendations.php">My Recommendations</a></td>
	      <td><a class="current" href="my_ratings.php">My Ratings</a></td>
            </tr>
          </table>
        </div>
        ...
        <table class="table table-striped list">
          <tr></tr>
	  <?php $items = $client -> getUserRatedItems(999999);
		foreach ($items as $item) {
		    ...
		    echo "<li> $description </li>";
                    echo "<div id='rate" . "$id" . "' class='rating' value = '" . $rating . "'>&nbsp;</div><div class='implementation'></div>";
    ...
    <script>
        $(document).ready(function() {
                ...
                ratings.each(function (i, el) {
                    ...
                    $(el).rating('rate.php', {maxvalue: 10, curvalue: rating});
                });
        });
      </script>
  </body>
