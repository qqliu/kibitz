...
$(".next-opt-2-info").click(function(){
	...
	current_fs = $(this).parent();
        if ($("#item-based-button-2").hasClass('button-active') && $("#ratings-based-button").hasClass('button-active')) {
