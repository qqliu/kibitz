$(document).ready(function() {
    ...
    repo_name = recommenders[client_id].repoName;
    sessionStorage.setItem("repo_name", repo_name);
    localStorage.setItem("repo_name", repo_name);
    table_name = recommenders[client_id].recommenderName;
    ...
    $("#homepage").append(homepageURL + username + "/" + recommenders[client_id].repoName + "/");
