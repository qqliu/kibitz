...
kibitz.Recommender = function(args) {
  ...
  if (args) {
    ...
    if (args.recommenderName !== undefined) {
      ...
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field recommenderName is unset!');
    }
    if (args.clientKey !== undefined) {
      this.clientKey = args.clientKey;
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field clientKey is unset!');
    }
    if (args.homepage !== undefined) {
      this.homepage = args.homepage;
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field homepage is unset!');
    }
    if (args.repoName !== undefined) {
      this.repoName = args.repoName;
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field repoName is unset!');
    }
    ...
    if (args.image !== undefined) {
      ...
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field image is unset!');
    }
    ...
    if (args.numRecs !== undefined) {
      ...
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field numRecs is unset!');
    }
    if (args.maxRatingVal !== undefined) {
      this.maxRatingVal = args.maxRatingVal;
    } else {
      throw new Thrift.TProtocolException(Thrift.TProtocolExceptionType.UNKNOWN, 'Required field maxRatingVal is unset!');
    }
...
kibitz.Recommender.prototype.write = function(output) {
  ...
  if (this.primaryKey !== null && this.primaryKey !== undefined) {
    output.writeFieldBegin('primaryKey', Thrift.Type.STRING, 15);
